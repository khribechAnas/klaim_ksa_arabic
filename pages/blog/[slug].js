...
export async function getServerSideProps({ params }) {
  const articlesResponse = await fetch(
    `http://strapi:1337/api/blog-articles?populate=*&filters[slug][$eq]=${params.slug}`,
    {
      headers: {
  ...
  const relatedArticlesResponse = await fetch(
    `http://strapi:1337/api/blog-articles?populate=*&pagination[limit]=2&sort=publishedOn:desc${relatedArticleFilters}`,
    {
      headers: {
        Authorization: `Bearer `,
      },
