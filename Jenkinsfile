      ...
      steps {
        script {
          ...
          if (BRANCH_NAME == 'stage') {
            ...
            IMAGE_VERSION = GIT_COMMIT
            BUILD_ARGS = '--build-arg APP_NAME="klaim_website" --build-arg STRAPI_ENDPOINT="https://strapi.stg.klaim.ai" --build-arg STRAPI_API_ENDPOINT="https://strapi.stg.klaim.ai/api" --build-arg  STRAPI_TOKEN="" '
