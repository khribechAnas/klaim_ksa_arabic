...
const XRayAccelerate = () => {
  return (
    <section className="container mx-auto py-12 md:py-32 px-4 md:px-0">
      ...
      <p className="text-[#3F465D] text-[28px] leading-[36px] mt-4 mb-8">
        Here are just a few examples of the areas you can track:
      </p>
      <div className="grid grid-cols-3 gap-4">
        <div className="py-4 px-12 bg-[#F5F7FB] rounded-lg flex items-center">
          <img src="assets/images/xray1.svg" />
          <div className="ml-12 text-[#3F465D]">
            <p className="mb-2 text-[32px] font-bold leading-[40px]">Claims</p>
        ...
        <div className="py-4 px-12 bg-[#F5F7FB] rounded-lg flex items-center">
          ...
          <div className="ml-12 text-[#3F465D]">
            <p className="mb-2 text-[32px] font-bold leading-[40px]">Team</p>
            <p className="text-[22px] leading-[30px]">
        ...
        <div className="py-4 px-12 bg-[#F5F7FB] rounded-lg flex items-center">
          <img src="assets/images/xray1.svg" />
          <div className="ml-12 text-[#3F465D]">
            <p className="mb-2 text-[32px] font-bold leading-[40px]">
              Activities
            </p>
            <p className="text-[22px] leading-[30px]">
