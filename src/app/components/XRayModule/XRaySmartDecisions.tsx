...
const XRaySmartDecisions = () => {
  return (
    <section className="bg-[#F5F7FB]">
      <div className="container mx-auto py-12 md:py-32 px-4 flex flex-col xl:flex-row">
        <img
          src="assets/images/xray4.png"
          className="flex-1 mr-4 hidden xl:block object-cover"
        />
        <div className="flex-1 ml-0 xl:ml-4 flex flex-col items-start justify-center">
        ...
        <img
          src="assets/images/xray4.png"
          className="flex-1 mt-8 block xl:hidden"
        />
      </div>
    </section>
  );
