      ...
      <div className="relative">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 absolute left-0 right-0 top-0 bottom-0">
          <div className="flex flex-col items-start justify-center md:px-0 px-4 pt-16 md:pt-0 h-[360px] md:h-auto">
            <p className="text-[#6135FB] leading-[24px] text-lg font-semibold">
              KLAIM X-RAY
            </p>
            <h1 className="text-[#3F465D] text-4xl md:text-6xl font-semibold leading-[44px] md:leading-[70px] tracking-tighter">
              Make Confident Data-Driven Decisions
            </h1>
            <h3 className="font-bold leading-[40px] text-[32px] text-[#3F465D]">
              For Faster Growth and Fewer Wrong Turns
            </h3>
            <p className="text-[18px] leading-[25px] text-[#3F465D] mr-0 md:pr-36 my-7">
