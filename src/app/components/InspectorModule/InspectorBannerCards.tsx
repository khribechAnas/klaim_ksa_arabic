  ...
  return (
    <section className="bg-linear py-8 md:py-16 px-4 md:px-0">
      <div className="flex flex-wrap items-center justify-center">
        ...
        <div className="px-2 md:px-6 py-4 text-white border-[3px] rounded-lg flex flex-col items-center justify-center w-56 mx-2 md:mx-4 my-2 md:my-0">
...
export default InspectorBannerCards;
