    ...
    <section className="container mx-auto py-12 md:py-32 px-4">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 mt-8">
        <div>
          ...
          <div className="mt-8 mb-4 xl:mb-0 text-[#3F465D] text-[1.25rem] md:text-[1.75rem] leading-[1.875rem] md:leading-[2.25rem]">
            Without reliable cash flow, achieving your top objectives becomes
            nearly impossible.
          </div>
        </div>
        <div className="flex items-center justify-end">
          <img src="assets/images/kapital1.png" className="w-full xl:w-auto" />
        </div>
      </div>
    </section>
  );
