        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-lg shadow-[0_0_16px_0_rgba(0,0,0,0.05)] px-8 py-7 flex md:block">
            ...
            <p className="text-[#3F465D] md:text-[1.375rem] leading-[1.625rem] md:leading-[1.875rem] ml-8 mt-0 md:mt-8 md:ml-0">
              Stabilize your cash <br className="block md:hidden" /> flow{" "}
              <br className="hidden md:block" /> and increase <br />{" "}
              profitability
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-[0_0_16px_0_rgba(0,0,0,0.05)] px-8 py-7 flex md:block">
            ...
            <p className="text-[#3F465D] md:text-[1.375rem] leading-[1.625rem] md:leading-[1.875rem] ml-8 mt-0 md:mt-8 md:ml-0">
              Reduce <br className="block md:hidden" /> administrative{" "}
              <br className="block md:hidden" /> expenses
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-[0_0_16px_0_rgba(0,0,0,0.05)] px-8 py-7 flex md:block">
            <img src="assets/images/kapital5.svg" />
            <p className="text-[#3F465D] md:text-[1.375rem] leading-[1.625rem] md:leading-[1.875rem] ml-8 mt-0 md:mt-8 md:ml-0">
              Finally catch up <br className="block md:hidden" /> on fixed costs
            </p>
          </div>
        </div>
