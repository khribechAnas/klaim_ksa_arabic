...
const KapitalWhatToExpect = () => {
  return (
    <section
      className="container mx-auto py-12 md:py-32 px-4"
      id="what-to-expect"
    >
      ...
      <div className="hidden md:grid grid-cols-4 mt-12">
        <div className="flex items-center">
          <div className="px-4 py-3 flex flex-col items-center rounded-lg bg-gradient-to-r from-[#6135fb] to-[#5f3ff7] w-[6.5rem]">
            <p className="text-white text-[2.625rem] font-bold mx-[0.5rem] xl:mx-0">
              01
            </p>
          </div>
        ...
        <div className="flex items-center">
          <div className="px-4 py-3 flex flex-col items-center rounded-lg bg-gradient-to-r from-[#5767e6] to-[#5572e1] w-[5.6rem]">
            <p className="text-white text-[2.625rem] font-bold mx-[0.5rem] xl:mx-0">
              02
            </p>
          </div>
        ...
        <div className="flex items-center">
          <div className="px-4 py-3 flex flex-col items-center rounded-lg bg-gradient-to-r from-[#4d99d0] to-[#4ba4cc] w-[5.6rem]">
            <p className="text-white text-[2.625rem] font-bold mx-[0.5rem] xl:mx-0">
              03
            </p>
          </div>
        ...
        <div className="flex items-center">
          <div className="px-4 py-3 flex flex-col items-center rounded-lg bg-gradient-to-r from-[#43ccbb] to-[#41d8b6] w-[5.6rem]">
            <p className="text-white text-[2.625rem] font-bold mx-[0.5rem] xl:mx-0">
              04
            </p>
          </div>
      ...
      <div className="block md:hidden mt-4 mb-16 grid grid-cols-1">
        <div className="flex items-center">
          ...
          <p className="text-[1.125rem] leading-[1.625rem] text-[#3F465D] ml-4">
            <span className="font-semibold">Express Your Interest:</span>
            <br /> Simply let us know you&apos;re keen to collaborate
          </p>
        </div>
        ...
        <div className="flex items-center">
          ...
          <p className="text-[1.125rem] leading-[1.625rem] text-[#3F465D] ml-4">
            <span className="font-semibold">Receive a No-Cost Proposal:</span>
            <br /> We&apos;ll provide you with a complimentary Claim Purchase
            Proposal
          </p>
        </div>
        ...
        <div className="flex items-center">
          ...
          <p className="text-[1.125rem] leading-[1.625rem] text-[#3F465D] ml-4">
            <span className="font-semibold">Quick Onboarding:</span>
            <br /> Join our network in as few as 5 days.
          </p>
        </div>
        ...
        <div className="flex items-center">
          ...
          <p className="text-[1.125rem] leading-[1.625rem] text-[#3F465D] ml-4">
            <span className="font-semibold">Experience Speedy Payments:</span>
            <br /> Enjoy the benefits of 24-hour claim payments
          </p>
        </div>
      </div>
      {/* Mobile End */}
      ...
      <div className="hidden md:grid grid-cols-4 mt-[1.06rem]">
        ...
        <div className="pr-6 lg:pr-24">
          <p className="text-[1.375rem] leading-[1.875rem] text-[#3F465D]">
            Get a no-cost Claim Purchase Proposal
          </p>
        </div>
        <div className="pr-6 lg:pr-24">
          <p className="text-[1.375rem] leading-[1.875rem] text-[#3F465D]">
            Onboard with us in as little as 5 days
          </p>
        </div>
        <div className="pr-6 lg:pr-24">
          <p className="text-[1.375rem] leading-[1.875rem] text-[#3F465D]">
            Start getting 24-hour claim payments
          </p>
        </div>
      </div>
