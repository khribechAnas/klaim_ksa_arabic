      ...
      <div className="relative">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="relative">
            ...
            <div className="bg-gradient-to-r from-white to-[rgba(255, 255, 255, 0.52)] absolute top-0 bottom-0 left-0 w-[50%]" />
          </div>
        </div>
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 absolute left-0 right-0 top-0 bottom-0">
          <div className="flex flex-col items-start justify-center md:px-0 px-4 pt-16 md:pt-0 h-[360px] md:h-auto">
            <h1 className="text-[#3F465D] text-4xl md:text-6xl font-semibold leading-[44px] md:leading-[70px] tracking-tighter mb-7">
              About us
            </h1>
            <p className="text-[18px] leading-[25px] text-[#3F465D] pr-36">
