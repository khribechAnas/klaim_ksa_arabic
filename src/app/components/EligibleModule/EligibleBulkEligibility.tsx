      ...
      <div className="container mx-auto py-12 md:py-32 px-4 md:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 mb-16">
          <div className="bg-white rounded-lg shadow-[0_0_16px_0_rgba(0,0,0,0.05)] px-8 py-7">
            ...
            <p className="text-[#3F465D] text-[1.125rem] md:text-[1.375rem] leading-[1.625rem] md:leading-[1.875rem] mt-4">
          ...
          <div className="bg-white rounded-lg shadow-[0_0_16px_0_rgba(0,0,0,0.05)] px-8 py-7">
            ...
            <p className="text-[#3F465D] md:text-[1.375rem] leading-[1.625rem] md:leading-[1.875rem] mt-4">
