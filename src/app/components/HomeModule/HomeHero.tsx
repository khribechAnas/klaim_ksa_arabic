...
const HomeHero = () => {
  ...
  return (
    <section className="pt-[74px] ">
      ...
      <div className="bg-linear px-8 md:px-16 py-8 2xl:py-14 grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-x-4 lg:gap-x-8 xl:gap-x-16 gap-y-8 items-center">
        <a
