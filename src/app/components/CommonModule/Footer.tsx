...
const Footer = () => {
  return (
    <>
      <footer className="bg-linear pt-8 pb-8 px-4 md:px-0 md:pt-32 md:pb-10">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center md:justify-between">
            ...
            <div className="flex items-center text-white font-bold leading-[16px] md:leading-4 text-sm md:text-lg tracking-tight mt-8 md:mt-0">
              <a className="pr-16">Home</a>
              <a>About Us</a>
            </div>
          </div>
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between my-8 md:my-16">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
            ...
            <div className="text-white text-sm md:text-base leading-[25px] leading-none">
              <p className="">
