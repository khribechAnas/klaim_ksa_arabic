...
const HowItWorks = () => {
  return (
    <section
      id="how-it-works"
      className="flex flex-col items-center justify-center gap-10 w-full relative px-6 pb-16"
    >
      <SectionHeader>
        <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-center text-balance">
          How Klaim Estate Works
        </h2>
        <p className="text-muted-foreground font-inter text-center text-balance font-medium">
        Klaim Estate is designed to make the process seamless, secure, and quick
        </p>
      </SectionHeader>
