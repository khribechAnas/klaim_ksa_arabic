    ...
    >
      <blockquote className="max-w-3xl text-left px-4">
        <p className="text-xl md:text-2xl text-primary leading-relaxed tracking-tighter font-medium mb-6">
          I used to wait 90 days. Now I get paid the next morning and move to
          the next deal.
        </p>
        ...
        <div className="flex gap-4">
          ...
          <div className="text-left">
            <cite className="text-lg  font-medium text-secondary not-italic">
              Fares
            </cite>
            <p className="text-sm text-primary">Agent, Dubai Marina</p>
          </div>
        </div>
      </blockquote>
    </section>
