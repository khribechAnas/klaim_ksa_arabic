    ...
    >
      <div className="w-full">
        <div className="h-[400px] md:h-[400px] overflow-hidden shadow-xl w-full border border-border rounded-xl relative z-20">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start px-6 md:px-12 lg:px-16 -mt-12">
            <div className="max-w-md md:max-w-2xl">
              <h1 className="text-white text-3xl md:text-4xl lg:text-6xl font-medium tracking-tighter text-left mb-24">
                {ctaSection.title}
              </h1>
