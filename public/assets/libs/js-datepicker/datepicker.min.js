!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      function h(e, t, n) {
        return [
          '<div className="qs-controls' + (n ? " qs-blur" : "") + '">',
          '<div className="qs-arrow qs-left"></div>',
          '<div className="qs-month-year' +
            (t.disableYearOverlay ? " qs-disabled-year-overlay" : "") +
            '">',
          '<span className="qs-month">' + t.months[e.getMonth()] + "</span>",
          '<span className="qs-year">' + e.getFullYear() + "</span>",
          "</div>",
      ...
      function f(e, t, n) {
        ...
        var R = d
          .map(function (e) {
            return '<div className="qs-square qs-day">' + e + "</div>";
          })
          .concat(q);
        return (
          R.unshift(
            '<div className="qs-squares' + (n ? " qs-blur" : "") + '">'
          ),
          R.push("</div>"),
          R.join("")
        );
      ...
      function v(e, t) {
        var n = e.overlayPlaceholder,
          a = e.overlayButton;
        return [
          '<div className="qs-overlay' + (t ? "" : " qs-hidden") + '">',
          "<div>",
          '<input className="qs-overlay-year" placeholder="' +
            n +
            '" inputmode="numeric" />',
          ...
          '<div className="qs-overlay-month-container">' +
            e.overlayMonths
              .map(function (e, t) {
                return (
                  '<div className="qs-overlay-month" data-month-num="' +
                  t +
                  '">' +
                  e +
                  "</div>"
              ...
              .join("") +
            "</div>",
          '<div className="qs-submit qs-disabled">' + a + "</div>",
          "</div>",
        ].join("");
      }
      function m(e, t, n) {
